...
public class ZengXian {
    ...
    private String sendlatestprd;
    private String sendlatestdate;
    ...
    public String getSendlatestprd() {
        return sendlatestprd;
    }

    public void setSendlatestprd(String sendlatestprd) {
        this.sendlatestprd = sendlatestprd;
    }

    public String getSendlatestdate() {
        return sendlatestdate;
    }

    public void setSendlatestdate(String sendlatestdate) {
        this.sendlatestdate = sendlatestdate;
    }
